...
// PathsMap is a map of all of the paths microovn needs mapped to their referance
// names so they can be easily accessed
var PathsMap = map[string]interface{}{
	"Root":                  Root(),
	"LogsDir":               LogsDir(),
	"OvnRuntimeDir":         OvnRuntimeDir(),
	"CentralDBDir":          CentralDBDir(),
	"CentralDBNBPath":       CentralDBNBPath(),
	"CentralDBSBPath":       CentralDBSBPath(),
	"CentralDBSBBackupPath": CentralDBSBBackupPath(),
	"CentralDBNBBackupPath": CentralDBNBBackupPath(),
	"SwitchDBDir":           SwitchDBDir(),
	"SwitchRuntimeDir":      SwitchRuntimeDir(),
	"SwitchDataDir":         SwitchDataDir(),
	"OvnEnvFile":            OvnEnvFile(),
	"OvnNBDatabaseSock":     OvnNBDatabaseSock(),
	"OvnSBDatabaseSock":     OvnSBDatabaseSock(),
	"OvnNBControlSock":      OvnNBControlSock(),
	"OvnSBControlSock":      OvnSBControlSock(),
	"OvsDatabaseSock":       OvsDatabaseSock(),
	"PkiDir":                PkiDir(),
	"EnvDir":                EnvDir(),
	"PkiCaCertFile":         PkiCaCertFile(),
	"OvsdbSbSchema":         OvsdbSbSchema(),
	"OvsdbNbSchema":         OvsdbNbSchema(),
	"OvsdbSwitchSchema":     OvsdbSwitchSchema(),
}
